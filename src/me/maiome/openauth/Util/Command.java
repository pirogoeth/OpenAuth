...
public class Command {
    ...
    public boolean addAlias (String alias) {
        ...
        try {
            ...
            log.info("[OpenAuth{Registry}] Could not register alias '" + alias + "'.");
            return false;
        }
        return false;
    }
    ...
    public boolean deleteAlias (String alias)
      throws CommandException {
        ...
        try {
            ...
            log.info("[OpenAuth{Registry}] Could not deregister alias '" + alias + "'.");
            return false;
        }
    }
      ...
      throws CommandException {
        ...
        while (alia_i.hasNext()) {
            ...
            try {
                ...
                log.info("[OpenAuth{Registry}] Could not deregister alias '" + a + "'.");
                return false;
            };
            return true;
        };
    ...
    public boolean register ()
      throws CommandException {
        ...
        try {
            ...
            log.info("[OpenAuth{Registry}] Could not register command '" + command + "'.");
            registered = false;
            return false;
        }
        registered = true;
