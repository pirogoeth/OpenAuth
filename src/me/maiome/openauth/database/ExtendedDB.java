...
/**
 * This is LennardF1989's BukkitEx ajave database extension to fix the problems presented
 * inside Bukkit's implementation. All I have done to it as of 5/31/12 is renamed the class, cleaned up some formatting, and
 * changed the package to fit into OpenAuth.
 *
 * I (pirogoeth) am in no way claiming this code as my own, so here's the proper attribution to the author.
 *
 * @author: Lennard Fonteijn <lennard@lennardf1989.com>
 * @website: http://www.lennardf1989.com
 * @active-thread: http://forums.bukkit.org/threads/bukkit-persistance-reimplemented-no-code-changes-required.24987/
 *
 * All credit goes to him, as he deserves.
 */
...
public class ExtendedDB {
    ...
    /**
     * Create an instance of ExtendedDB
     *
     * @param javaPlugin Plugin instancing this database
     */
    public ExtendedDB(JavaPlugin javaPlugin) {
    ...
    private void prepareDatabase(String driver, String url, String username, String password, String isolation) {
        ...
        List<Class<?>> classes = this.javaPlugin.getDatabaseClasses();
    ...
    protected List<Class<?>> getDatabaseClasses() {
        ...
        // going to return:
        return this.javaPlugin.getDatabaseClasses();
    }
